...
// تشغيل التهيئة
// ملاحظة: هذا الملف يُحقَن ديناميكياً بعد اكتمال تحليل الصفحة، لذا حدث
// DOMContentLoaded يكون قد وقع بالفعل قبل وصول هذا السطر - نفس مشكلة
// app.js (راجع الشرح المفصّل هناك). نتحقق من readyState بدل الاعتماد
// على حدث لن يتكرر، وإلا فـ initPWA() لا تُستدعى أبداً.

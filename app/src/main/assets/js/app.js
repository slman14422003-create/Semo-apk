...
// ================================================================
// مهم جداً: عدّل هذين الرقمين يدوياً بكل مرة تبني وتنشر فيها نسخة APK جديدة
// (بالتزامن مع versionCode/versionName بملف android/app/build.gradle
// بمشروع أندرويد الأصلي)، وإلا لن يكتشف التطبيق وجود تحديث جديد. الأهم هو
// APP_VERSION_CODE (رقم صحيح يزيد بـ 1 كل نسخة) — هو المعيار الذي تُقارَن
// عليه التحديثات، أما APP_VERSION_NAME فهو نصي للعرض فقط (مثل "1.2.0").

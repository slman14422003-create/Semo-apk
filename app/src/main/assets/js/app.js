                ...
                adminListHtml += `
                    <div class="user-item">
                        ...
                        <div class="actions-group">
                            ${data.blocked ? 
                                `<button class="btn-unblock" onclick="unblockUser('${uidAttr}')" title="فك الحظر">🔓 فك</button>` :
                                `<button class="btn-block" onclick="blockUser('${uidAttr}')" title="حظر المستخدم">⛔ حظر</button>`
                            }
                            ${data.banned ? 
                                `<button class="btn-unblock" onclick="unbanUser('${uidAttr}')" title="إلغاء الحظر المؤقت">🔓 إلغاء الحظر</button>` : ''
                            }
                            ...
                            <button class="btn-warn" onclick="warnUser('${uidAttr}')" title="إرسال تحذير">⚠️ تحذير</button>
                        </div>
                    </div>
                `;
            }

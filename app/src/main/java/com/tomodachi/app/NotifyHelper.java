...
final class NotifyHelper {
    ...
    static void postMessageNotification(Context context, String title, String body) {
        ...
        // القيم الافتراضية عند نص فارغ/null - عبارة نمط الأسهم بدل شرط
        // ثلاثي متداخل، أوضح لقارئ الكود عن الحالة الافتراضية المقصودة.
        String safeTitle = (title == null || title.isEmpty()) ? "Tomodachi" : title;
        String safeBody = (body == null) ? "" : body;

        var builder = new NotificationCompat.Builder(context, MESSAGES_CHANNEL_ID)
